...
import SpecialityCenters from 'components/views/speciality-center'
import Header from 'components/views/partials/header'
import Footer from 'components/views/partials/footer'
import Request from 'utils/request';

class SpecialityCentersPage extends React.Component {

  static async getInitialProps({ req, query }) {
    const Response = await Request.getGlobals();
    const specialityResponse = await Request.getObject('specialty-centers-and-programs');
    const speciality = specialityResponse.object;
    const globals = mapGlobals(Response.objects);
    return { globals, speciality };
  }
	...
	render() {
      ...
      <Meta>
        <Head>
          ...
          <meta name="description" content={ this.state.speciality.metadata.seo_description.value } />
        ...
        <SpecialityCenters speciality={this.state.speciality}></SpecialityCenters>
...
export default SpecialityCentersPage;
